package com.hawaiki.network.inventory.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("NetworkInventory");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("NetworkInventory");
        ...
        config.getMapConfigs().put("com.hawaiki.network.inventory.domain.*", initializeDomainMapConfig(jHipsterProperties));
